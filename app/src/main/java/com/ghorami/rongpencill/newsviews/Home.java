...
public class Home extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private DataAdapterNews adapter;
   ...
   // private final static String url = "http://sopnobari.com/api/newsApi.php";
    ...
    private void setListViewAdapter() {
        ...
        adapter = new DataAdapterNews(getApplicationContext(),tours);
    ...
    public class GetJsonFromUrlTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ((Home) activity).parseJsonResponse(result);
            dialog.dismiss();
            Log.i(TAG, result);
        }
        ...
        public JSONObject loadJSON(String url) {
            ...
            Home.GetJsonFromUrlTask.JSONGetter jParser = new Home.GetJsonFromUrlTask.JSONGetter();
